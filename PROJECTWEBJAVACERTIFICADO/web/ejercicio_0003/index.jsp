...
<html>
    ...
    <center>
        <form action=''>
            <input type='text' name='txtA' value='<%=a%>' placeholder="A" /><br><br>
            <input type='text' name='txtB' value='<%=b%>' placeholder='B' /><br><br>
            <input type='text' name='txtC' value='<%=c%>' placeholder='C'/><br><br>

            <input type='text' name='txtX1' value='<%=x1%>' placeholder="X1" disabled />
            <input type='text' name='txtX2' value='<%=x2%>' placeholder="X2" disabled /><br><br>
            <input type='text' name='txtM' value='<%=m%>' size='20' style='width: 300px' disabled /><br><br> 
